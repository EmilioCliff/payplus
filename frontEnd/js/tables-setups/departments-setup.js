import { fetchData } from "../table.js";

const departmentButton = document.getElementById("js-department-button");
const companyDetailsBtn = document.getElementById("js-company-details-button");
const sectionSetupBtn = document.getElementById("js-section-setup-button");
const jobTitlesSetupBtn = document.getElementById("js-job-titles-setup-button");
const gradesSetupBtn = document.getElementById("js-grades-setup-button");

export let tableSection = document.getElementById("js-table-section");

departmentButton.addEventListener("click", () => showTable("departmentTable"));
companyDetailsBtn.addEventListener("click", () => showTable("companyDetails"));
sectionSetupBtn.addEventListener("click", () => showTable("sectionSetup"));
jobTitlesSetupBtn.addEventListener("click", () => showTable("jobTitlesSetup"));
gradesSetupBtn.addEventListener("click", () => showTable("gradesSetup"));
